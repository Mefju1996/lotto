...
def generate_numbers():
    while True:
        # Losowanie 6 liczb z przedziału 1-100 (możesz dostosować ten zakres)
        numbers = sorted(random.sample(range(1, 101), 6))
...
print("Wylosowane liczby:", result)
